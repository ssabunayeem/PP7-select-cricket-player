...
const AvailablePlayers = ({ playerPromise, setAvailableBalance, availableBalance }) => {
    ...
    return (
        <div className='max-w-[1240px] mx-auto my-10 grid grid-cols-1 md:grid-cols-3 gap-15 px-5 md:px-0'>
            ...
            {
                players.map(player => <PlayerCard availableBalance={availableBalance} setAvailableBalance={setAvailableBalance} key={player.player_name} player={player}></PlayerCard>)
            }
